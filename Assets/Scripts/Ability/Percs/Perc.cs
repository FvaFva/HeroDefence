...
public class Perc : Ability
{
    ...
    public void ExecuteDepenceAction(Character root, Character target, float damage, PercActionType type)
    {
...
public struct ActionTrigger
{
    ...
    public void ExecuteActionIfRandomize(Character root, Character target, float damage)
    {
